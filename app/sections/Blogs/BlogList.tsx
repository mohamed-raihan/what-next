...
export default function BlogList() {
    ...
    return (
        <div className="relative">
            ...
            <div className="relative bg-[url(/service-bg.svg)] bg-cover flex flex-col lg:flex-row justify-between bg-no-repeat  pt-10 md:pt-35 px-2 md:px-10 lg:px-25 h-auto md:h-[80vh]">
