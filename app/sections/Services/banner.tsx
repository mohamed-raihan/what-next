...
const ServiceBanner = () => {
    ...
    return (
        <Suspense fallback={
            ...
            <div>
                <div className="relative xl:bg-[url(/bannerBg1.svg)] flex flex-col md:flex-row items-center justify-between px-4 py-8 md:px-8 h-auto xl:h-[80vh] 2xl:h-[85vh] w-full bg-no-repeat">
                    {/* Left Column */}
